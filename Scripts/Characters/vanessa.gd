...
@onready var life_bar_full = $"../CanvasLayer/HUD_Life_Full_Vanessa"  # Vida cheia
@onready var life_bar_hurt_1 = $"../CanvasLayer/HUD_Life_Hurt_Vanessa"  # 3 barrinhas
@onready var life_bar_hurt_2 = $"../CanvasLayer/HUD_Life_Hurt2_Vanessa"  # 2 barrinhas
@onready var life_bar_hurt_3 = $"../CanvasLayer/HUD_Life_Hurt3_Vanessa"  # 1 barrinha
@onready var life_bar_dead = $"../CanvasLayer/HUD_Life_Dead_Vanessa"  # Morta
...
func update_life_bar():
	...
	if life_bar_hurt_1 and life_bar_hurt_1.is_inside_tree():
		life_bar_hurt_1.visible = false
	if life_bar_hurt_2 and life_bar_hurt_2.is_inside_tree():
		life_bar_hurt_2.visible = false
	if life_bar_hurt_3 and life_bar_hurt_3.is_inside_tree():
		life_bar_hurt_3.visible = false
	...
	elif current_health == 3 and life_bar_hurt_1 and life_bar_hurt_1.is_inside_tree():
		life_bar_hurt_1.visible = true
	elif current_health == 2 and life_bar_hurt_2 and life_bar_hurt_2.is_inside_tree():
		life_bar_hurt_2.visible = true
	elif current_health == 1 and life_bar_hurt_3 and life_bar_hurt_3.is_inside_tree():
		life_bar_hurt_3.visible = true
...
func take_damage(amount: int):
	...
	if current_health > 0:
		is_invincible = true
		print("Vanessa está invencível por", invincibility_time, "segundos")
		await get_tree().create_timer(invincibility_time).timeout
		is_invincible = false
		print("Vanessa não está mais invencível")
	else:
		die()
